...
personality_traits = []
try:
    with open("memory/personality.json", "r", encoding="utf-8") as f:
...
base_identity = (
    ...
    "Avoid literal stage directions like 'low, mysterious chuckle' in voice responses. Laughing naturally is fine — stay in character."
)
